...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            ...
            string[] dogCharacteristic = new string[0];
                ...
                if (ourAnimals[i, 1].Contains("dog"))
                {
                    ...
                    for (int j = 0; j < dogCharacteristic.Length; j++)
                    {
                        ...
                        // #5 update "searching" message to show countdown 
                            ...
                            {
                                Console.Write($"\rsearching our dog {ourAnimals[i, 3]} for {dogCharacteristic[j].Trim()} {icon} {k.ToString()}");
                                Thread.Sleep(100);
                            }
                        ...
                        if (dogDescription.Contains(dogCharacteristic[j]))
                        {
                            ...
                            Console.WriteLine($"\rOur dog {ourAnimals[i, 3]} matches your search for {dogCharacteristic[j]}");
            ...
            if (noMatchesDog)
            {
                Console.WriteLine("None of our dogs are a match found for: " + string.Join("", dogCharacteristic));
            }
